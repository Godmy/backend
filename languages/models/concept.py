...
class ConceptModel(BaseModel):
    ...
    parent_id = Column(Integer, ForeignKey("concepts.id", ondelete="SET NULL"), nullable=True, comment="ID родительской концепции")
    ...
    parent = relationship(
        "ConceptModel", 
        remote_side="ConceptModel.id", 
        backref="children",
        foreign_keys=[parent_id]
    )
    dictionaries = relationship("DictionaryModel", back_populates="concept", cascade="all, delete-orphan")
