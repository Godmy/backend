...
class ConceptService:
    ...
    def get_by_id(self, concept_id: int) -> Optional[ConceptModel]:
        ...
        return self.db.query(ConceptModel).filter(
    ...
    def delete(self, concept_id: int) -> bool:
        ...
        if children:
            raise ValueError(
                f"Cannot delete concept {concept_id}: "
                f"it has {len(children)} child concepts"
            )
