...
class DictionaryService:
    ...
    def create(
        ...
        concept = self.db.query(ConceptModel).filter(
        ...
        language = self.db.query(LanguageModel).filter(
