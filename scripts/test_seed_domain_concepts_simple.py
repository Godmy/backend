#!/usr/bin/env python3
"""
Тестовый скрипт для проверки корректности импорта упрощённого скрипта инициализации доменных данных
"""
...
def test_import():
    """Проверка импорта упрощённого скрипта инициализации"""
    try:
        # Попытка импортировать скрипт
        from scripts.seed_domain_concepts_simple import seed_domain_concepts_clean
...
def test_functions_exist():
    ...
    try:
        from scripts.seed_domain_concepts_simple import (
            load_domain_data,
            create_concept_hierarchy,
            create_dictionary_entries,
            seed_domain_concepts_clean
        )
...
def main():
    ...
    print("Testing simplified domain concepts seeding script...")
    print("=" * 50)
